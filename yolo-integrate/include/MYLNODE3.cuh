#ifndef INTG_CUSTOM_MYLNODE3_PLUGIN_H
#define INTG_CUSTOM_MYLNODE3_PLUGIN_H
...
class MYLNODE3Plugin : public IPluginV2DynamicExt{

public:
   
    MYLNODE3Plugin(const string name);
    ...
    virtual size_t getWorkspaceSize(
        ...
        const nvinfer1::PluginTensorDesc *outputs, int32_t nbOutputs
    )const noexcept override{
        return 0;
    }

    int enqueue(
        const nvinfer1::PluginTensorDesc *inputDesc, const nvinfer1::PluginTensorDesc *outputsDesc,
...
class MYLNODE3PluginCreator : public IPluginCreator
{

public :
    MYLNODE3PluginCreator();
