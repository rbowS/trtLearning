#ifndef INTG_CUSTOM_MYLNODE1_PLUGIN_H
#define INTG_CUSTOM_MYLNODE1_PLUGIN_H
...
class MYLNODE1Plugin : public IPluginV2DynamicExt{

public:

    MYLNODE1Plugin(const string name);
...
class MYLNODE1PluginCreator : public IPluginCreator
{

public :
    MYLNODE1PluginCreator();
