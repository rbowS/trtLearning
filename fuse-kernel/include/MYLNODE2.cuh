#ifndef CUSTOM_MYLNODE2_PLUGIN_H
#define CUSTOM_MYLNODE2_PLUGIN_H
...
class MYLNODE2Plugin : public IPluginV2DynamicExt{

public:
   
    MYLNODE2Plugin(const string name);
...
class MYLNODE2PluginCreator : public IPluginCreator
{

public :
    MYLNODE2PluginCreator();
